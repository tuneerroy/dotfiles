...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; (only in insert state). Currently supported keyboard layouts are: ;; `qwerty-us', `qwertz-de' and `querty-ca-fr'.
...
before packages are loaded."
  ...
  ;; Custom keybindings for moving 5 lines at a time with Shift+j and Shift+k
